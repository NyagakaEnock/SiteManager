...
Begin VB.Form frmRptODASAllRoadSites 
   Caption         =   "Form1"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ...
   End
End
Attribute VB_Name = "frmRptODASAllRoadSites"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New RptODASAllRoadSites

Private Sub Form_Load()
 Set rsFindRecord = New ADODB.Recordset
 rsFindRecord.Open "Select * From ODASPPlot where OnRoadReserve='Y';", cnCOMMON, adOpenKeyset, adLockOptimistic
...
Report.RecordSelectionFormula = "{ODASPPlot.OnRoadReserve}='Y'"
