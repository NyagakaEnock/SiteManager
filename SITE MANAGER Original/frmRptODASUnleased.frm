...
Begin VB.Form frmRptODASUnleased 
   Caption         =   "Form1"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ...
   End
End
Attribute VB_Name = "frmRptODASUnleased"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New RptODASUnleased
...
f = frmODASSitesOnRoadReserve.txtStartDate.Text
G = frmODASSitesOnRoadReserve.txtLastDate.Text
