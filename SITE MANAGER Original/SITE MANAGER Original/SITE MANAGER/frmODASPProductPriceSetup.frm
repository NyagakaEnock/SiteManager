...
Begin VB.Form frmODASPProductPriceSetup 
   ...
   ClientTop       =   3510
   ClientWidth     =   11880
   Icon            =   "frmODASPProductPriceSetup.frx":0000
   LinkTopic       =   "Form1"
   MinButton       =   0   'False
   Picture         =   "frmODASPProductPriceSetup.frx":0442
   ScaleHeight     =   8010
   ScaleWidth      =   11880
   ...
   Begin MSComctlLib.StatusBar StatusBar1 
      ...
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel1 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   4304
            MinWidth        =   4304
            Picture         =   "frmODASPProductPriceSetup.frx":5B80
...
Option Explicit
Private MyCostPrice As clsODASSettings
...
Private Sub Form_Initialize()
    Set MyCostPrice = New clsODASSettings
End Sub
