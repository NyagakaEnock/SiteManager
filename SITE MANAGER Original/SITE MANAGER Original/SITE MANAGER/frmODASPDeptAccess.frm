...
Begin VB.Form frmODASPDeptAccess 
   Caption         =   "Departmental Access"
   ClientHeight    =   5640
   ClientLeft      =   60
   ClientTop       =   1170
   ClientWidth     =   9225
   Icon            =   "frmODASPDeptAccess.frx":0000
   LinkTopic       =   "Form1"
   Picture         =   "frmODASPDeptAccess.frx":0442
   ScaleHeight     =   5640
   ScaleWidth      =   9225
   Begin VB.Frame Frame12 
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.CommandButton cmdAddNew 
            ...
            Height          =   375
            Left            =   120
            Picture         =   "frmODASPDeptAccess.frx":0784
            Style           =   1  'Graphical
            TabIndex        =   0
            Top             =   240
            Width           =   855
         ...
         Begin VB.CommandButton cmdUpdate 
            ...
            Height          =   375
            Left            =   120
            Picture         =   "frmODASPDeptAccess.frx":0886
            Style           =   1  'Graphical
            TabIndex        =   5
            Top             =   600
            Width           =   855
         ...
         Begin VB.CommandButton cmdSearch 
            ...
            Height          =   375
            Left            =   120
            Picture         =   "frmODASPDeptAccess.frx":0988
            Style           =   1  'Graphical
            TabIndex        =   7
            Top             =   1365
            Width           =   855
         ...
         Begin VB.CommandButton cmdDelete 
            ...
            Height          =   375
            Left            =   120
            Picture         =   "frmODASPDeptAccess.frx":0A8A
            Style           =   1  'Graphical
            TabIndex        =   6
            Top             =   1740
            Width           =   855
         ...
         Begin VB.CommandButton cmdCancel 
            ...
            Height          =   375
            Left            =   120
            Picture         =   "frmODASPDeptAccess.frx":0B8C
            Style           =   1  'Graphical
            TabIndex        =   4
            Top             =   2115
            Width           =   855
         ...
         Begin VB.CommandButton cmdPrint 
            ...
            Height          =   375
            Left            =   120
            Picture         =   "frmODASPDeptAccess.frx":0C8E
            Style           =   1  'Graphical
            TabIndex        =   3
            Top             =   2520
            Width           =   855
   ...
   End
End
Attribute VB_Name = "frmODASPDeptAccess"
