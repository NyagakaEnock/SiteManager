...
Begin VB.Form frmODASMContractEditing 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboClauseCode 
         BackColor       =   &H00FFC0C0&
         Height          =   315
         ItemData        =   "frmODASMContractEditing.frx":0000
         Left            =   1920
         List            =   "frmODASMContractEditing.frx":0002
         TabIndex        =   13
         Text            =   " "
         Top             =   1320
         Width           =   2175
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.TextBox txtClauseDetails 
            ...
            TabIndex        =   10
            Text            =   "frmODASMContractEditing.frx":0004
            Top             =   240
            Width           =   11415
         End
      End
   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmODASMContractEditing.frx":0006
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmODASMContractEditing.frx":0680
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmODASMContractEditing.frx":0BC2
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmODASMContractEditing.frx":1014
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmODASMContractEditing.frx":132E
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmODASMContractEditing.frx":19A8
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmODASMContractEditing.frx":2022
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmODASMContractEditing.frx":2474
               Key             =   ""
            EndProperty
         EndProperty
      End
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            NumListImages   =   7
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmODASMContractEditing.frx":2AEE
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmODASMContractEditing.frx":3168
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmODASMContractEditing.frx":35BA
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmODASMContractEditing.frx":38D4
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmODASMContractEditing.frx":3F4E
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmODASMContractEditing.frx":45C8
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmODASMContractEditing.frx":4A1A
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "frmODASMContractEditing"
...
On Error GoTo err
    With Me
        ...
        rsFindRecord2.Open "SELECT * FROM ODASPAccount A,ODASPPlot P, ODASMLeaseAgreement LA WHERE LA.ContractNo = '" & CurrentRecord & "' and LA.PlotNo = P.PlotNo and LA.AccountNo = A.AccountNo;", cnCOMMON, adOpenKeyset, adLockOptimistic
        .txtLandLord.Text = rsFindRecord2!CompanyName
        .txtPhysicalLocation.Text = rsFindRecord2!PhysicalLocation
    End With
Exit Sub
err:
ErrorMessage
...
On Error GoTo err
    With Me
        ...
        rsFindRecord.Open "SELECT * FROM ODASPClause WHERE ClauseDescription = '" & .cboClauseCode.Text & "';", cnCOMMON, adOpenKeyset, adLockOptimistic
        If rsFindRecord.EOF And rsFindRecord.BOF Then Exit Sub
            .txtClauseDescription.Text = rsFindRecord!ClauseDescription
            .cboClauseCode.Text = rsFindRecord!Clause
...
On Error GoTo err
    ...
    With frmODASMContractEditing
            ...
            If rsSAVE.BOF Or rsSAVE.EOF Then
                 rsSAVE.AddNew
                rsSAVE!Clause = .cboClauseCode.Text
...
On Error GoTo err
    ...
    With frmODASMContractEditing
            ...
            strSQL = "Select * from ODASMClause Where ContractNo = '" & .txtContractNo.Text & "' and ClauseNo = '" & .cboClauseCode.Text & "' "
            rsSAVE.Open strSQL, cnCOMMON, adOpenKeyset, adLockOptimistic
            
            If rsSAVE.BOF Or rsSAVE.EOF Then
                 rsSAVE.AddNew
                rsSAVE!ContractNo = .txtContractNo.Text
                rsSAVE!ClauseNo = CInt(.cboClauseCode.Text)
                rsSAVE!PreparedBY = CurrentUserName
                rsSAVE!DatePrepared = Date
            End If
                rsSAVE!ClauseDetails = .txtClauseDetails.Text
