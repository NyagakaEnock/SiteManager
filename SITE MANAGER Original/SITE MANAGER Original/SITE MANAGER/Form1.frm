...
Begin VB.Form ODASRLandLordRents 
   Caption         =   "LANDLORD RENT"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   End
End
Attribute VB_Name = "ODASRLandLordRents"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New ODASRLandLordsRent
...
Report.RecordSelectionFormula = "{ODASMInstallment.PaymentDueDate} = {ODASPPlotMast.RentDueDate} AND {ODASPPlotMast.RentDueDate}"
...
'    rsFindRecord.Open "Select * From ODASMLeaseAgreement ", cnCOMMON, adOpenKeyset, adLockOptimistic
'    'rsFindRecord.Open "Select * From ODASMLeaseAgreement Where ContractNo = '" & frmODASMLeaseAgreement.txtContractNo & "'", cnCOMMON, adOpenKeyset, adLockOptimistic
