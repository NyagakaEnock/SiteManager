...
Begin VB.Form frmODASMApproval 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   ...
   ClientTop       =   1170
   ClientWidth     =   8010
   Icon            =   "frmODASMApproval.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   5190
   ScaleWidth      =   8010
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton cmdDelete 
            ...
            Height          =   435
            Left            =   120
            Picture         =   "frmODASMApproval.frx":0442
            Style           =   1  'Graphical
            TabIndex        =   25
            Top             =   1860
            Width           =   975
         ...
         Begin VB.CommandButton cmdSearch 
            ...
            Height          =   435
            Left            =   120
            Picture         =   "frmODASMApproval.frx":0544
            Style           =   1  'Graphical
            TabIndex        =   24
            Top             =   990
            Width           =   975
         ...
         Begin VB.CommandButton cmdUpdate 
            ...
            Height          =   375
            Left            =   120
            Picture         =   "frmODASMApproval.frx":0646
            Style           =   1  'Graphical
            TabIndex        =   4
            Top             =   600
            Width           =   975
         ...
         Begin VB.CommandButton cmdCancel 
            ...
            Height          =   435
            Left            =   120
            Picture         =   "frmODASMApproval.frx":0748
            Style           =   1  'Graphical
            TabIndex        =   5
            Top             =   2295
            Width           =   975
         ...
         Begin VB.CommandButton cmdADDNEW 
            ...
            Height          =   375
            Left            =   120
            Picture         =   "frmODASMApproval.frx":084A
            Style           =   1  'Graphical
            TabIndex        =   0
            Top             =   240
            Width           =   975
   ...
   End
End
Attribute VB_Name = "frmODASMApproval"
...
On Error GoTo err
    ...
    With rsSAVE
            ...
            !UserName = frmALISMLoanOperation.cboUserCode.Text
...
On Error GoTo err
        ...
        rsPASSWORD.Open "SELECT * FROM ODASPApprovers WHERE Names = '" & cboUserCode & "' and operationType = '" & frmALISMLoanOperation.txtOperationType & " ';", cnCOMMON, adOpenKeyset, adLockOptimistic
