...
Begin VB.Form frmODASRLandlordSites 
   Caption         =   "LANDLORD SITES"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   End
End
Attribute VB_Name = "frmODASRLandlordSites"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New ODASRPlotSites
...
Report.RecordSelectionFormula = "{ODASPPlot.AccountNo} = '" & frmODASPLandLord.txtLandLordNo.Text & "';"
