...
Begin VB.Form frmRsPaymentsReceipts 
   ...
   EndProperty
   Icon            =   "frmRsPaymentsReceipts.frx":0000
   LinkTopic       =   "Form1"
   MinButton       =   0   'False
   Picture         =   "frmRsPaymentsReceipts.frx":0442
   ScaleHeight     =   8190
   ScaleWidth      =   11880
   ...
   Begin MSComctlLib.StatusBar StatusBar1 
      ...
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel1 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   4657
            MinWidth        =   4657
            Picture         =   "frmRsPaymentsReceipts.frx":5B80
            Text            =   "CONTRACTS REQ."
   ...
   Begin VB.Menu mnuShow 
      ...
      Begin VB.Menu mnuShowCurrentPurchaseOrders 
         Caption         =   "Show Current Contract Requisitions"
         Shortcut        =   ^{F6}
      End
   ...
   End
End
Attribute VB_Name = "frmRsPaymentsReceipts"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private MyContracts As clsRsPaymentsReceipts, OrderTotalSum, Ordate, PromDate, ReqDate
...
'        frmRPTPurchaseOrderForm.Show 1, frmRsContractRequisition
...
'On Error GoTo Err
With Me
    Set rsFindRecord = cnCOMMON.Execute("SELECT Sum(AdvCost) As Total FROM AdvertContractRequisition WHERE PurchaseOrderno = '" & Trim(.txtOrderNO.Text) & "'")
...
rsLIST.Open "SELECT * FROM AdvertContractRequisition A,AdvertContractRequisitionData B WHERE A.PurchaseOrderNo = B.PurchaseOrderNo AND A.RenewalStatus = '" & "Y" & "' AND B.RenewalStatus = '" & "Y" & "' AND A.EndDate < '" & Today & "' AND B.contractEndDate < '" & Today & "'  ORDER BY B.PurchaseOrderNo ;", cnCOMMON, adOpenKeyset, adLockOptimistic
...
Private Sub Form_Initialize()
    Set MyContracts = New clsRsPaymentsReceipts
End Sub
