...
Begin VB.Form frmODASRMaitananceBSchedule 
   Caption         =   "MaitananceSchedule"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   End
End
Attribute VB_Name = "frmODASRMaitananceBSchedule"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New ODASRMaitananceBSchedule
...
Report.RecordSelectionFormula = "{ODASMJobBriefItems.JobBriefItemNo } = '" & SchedulingMain.txtJobBriefItemNo.Text & "' "
