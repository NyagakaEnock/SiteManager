...
Begin VB.Form frmODASMSiteRegistration2 
   ...
   ClientTop       =   435
   ClientWidth     =   13665
   Icon            =   "frmODASMSiteRegistration1.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8910
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmODASMSiteRegistration1.frx":0442
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmODASMSiteRegistration1.frx":0ABC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmODASMSiteRegistration1.frx":0F0E
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmODASMSiteRegistration1.frx":1228
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmODASMSiteRegistration1.frx":18A2
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmODASMSiteRegistration1.frx":1F1C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmODASMSiteRegistration1.frx":236E
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmODASMSiteRegistration1.frx":29E8
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmODASMSiteRegistration1.frx":2DBA
      ...
      TabPicture(1)   =   "frmODASMSiteRegistration1.frx":2DD6
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "ListView3"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "View All Plots"
      TabPicture(2)   =   "frmODASMSiteRegistration1.frx":2DF2
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "ListView1"
      Tab(2).ControlCount=   1
      TabCaption(3)   =   "Assign Specification"
      TabPicture(3)   =   "frmODASMSiteRegistration1.frx":2E0E
      ...
      TabPicture(4)   =   "frmODASMSiteRegistration1.frx":2E2A
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "ListView2"
      Tab(4).ControlCount=   1
      TabCaption(5)   =   "Select Landlord"
      TabPicture(5)   =   "frmODASMSiteRegistration1.frx":2E46
      Tab(5).ControlEnabled=   0   'False
      Tab(5).Control(0)=   "ListALLLandLords"
      Tab(5).ControlCount=   1
      TabCaption(6)   =   "Installments"
      TabPicture(6)   =   "frmODASMSiteRegistration1.frx":2E62
      Tab(6).ControlEnabled=   0   'False
      Tab(6).Control(0)=   "Label19"
      Tab(6).Control(1)=   "Label26"
      Tab(6).Control(2)=   "Label40"
      Tab(6).Control(3)=   "txtSerialNo"
      Tab(6).Control(4)=   "Label41"
      Tab(6).Control(5)=   "Label42"
      Tab(6).Control(6)=   "Label44"
      Tab(6).Control(7)=   "Label43"
      Tab(6).Control(8)=   "ListALLInstallments"
      Tab(6).Control(9)=   "txtInstallmentPercent"
      Tab(6).Control(10)=   "txtPaymentDue"
      Tab(6).Control(11)=   "txtInstallment"
      Tab(6).Control(12)=   "txtTransactionNo"
      Tab(6).Control(13)=   "txtCurrentPeriod"
      Tab(6).Control(14)=   "txtContractYear"
      Tab(6).Control(15)=   "chkPaymentFlag"
      Tab(6).Control(16)=   "cmdSave"
      Tab(6).Control(17)=   "txtInvoiceNo"
      Tab(6).Control(18)=   "txtPaymentDueDate"
   ...
   End
End
Attribute VB_Name = "frmODASMSiteRegistration2"
...
With frmODASMSiteRegistration1
...
On Error GoTo err
        ...
        If Item.Checked = True Then
            ...
            frmODASMSiteRegistration1.txtPropertyCode.Text = Item.Text
...
On Error GoTo err
        ...
        If Item.Checked = True Then
            ...
            frmODASMSiteRegistration1.txtTransactionNo.Text = Item.Text
            loadINSTALLMENT
        Else
            Item.Checked = False
        End If
...
On Error GoTo err
        ...
        If Item.Checked = True Then
            ...
            frmODASMSiteRegistration1.txtLandLordNo.Text = Item.Text
...
On Error GoTo err
        ...
        If Item.Checked = True Then
            ...
            frmODASMSiteRegistration1.txtPlotNo.Text = Item.Text
...
On Error GoTo err
        ...
        If Item.Checked = True Then
            ...
            frmODASMSiteRegistration1.txtMastNo.Text = Item.Text

            rsSITE.loadMAST frmODASMSiteRegistration1.txtMastNo.Text
            showALLSITES
            showALLINSTALLMENTSDUE
        Else
            Item.Checked = False
...
On Error GoTo err
        ...
        If Item.Checked = True Then
            ...
            frmODASMSiteRegistration1.txtSiteNo.Text = Item.Text
            frmODASMSiteRegistration1.txtMastNo.Text = Item.SubItems(1)

            rsSITE.loadSITE frmODASMSiteRegistration1.txtSiteNo.Text
            rsSITE.loadMAST frmODASMSiteRegistration1.txtMastNo.Text
...
On Error GoTo err
        ...
        Case "P"
                ...
                frmODASRPlotSites.Show 1, frmODASMSiteRegistration1
        Case "H"
