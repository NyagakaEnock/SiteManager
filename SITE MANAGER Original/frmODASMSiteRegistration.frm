...
Begin VB.Form frmODASMSiteRegistration 
   ...
   ClientTop       =   435
   ClientWidth     =   13665
   Icon            =   "frmODASMSiteRegistration.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8910
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmODASMSiteRegistration.frx":0442
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmODASMSiteRegistration.frx":0ABC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmODASMSiteRegistration.frx":0F0E
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmODASMSiteRegistration.frx":1228
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmODASMSiteRegistration.frx":18A2
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmODASMSiteRegistration.frx":1F1C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmODASMSiteRegistration.frx":236E
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmODASMSiteRegistration.frx":29E8
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmODASMSiteRegistration.frx":2DBA
   ...
   End
End
Attribute VB_Name = "frmODASMSiteRegistration"
...
Me.cmdSaveContract.Enabled = False
...
If editRECORD Then
Else
    MsgBox "Click on the Edit/Change button to Renew Contract", vbExclamation
    Exit Sub
End If
...
rsSITE.enableContract
Me.cmdNewContract.Enabled = False
Me.cmdSaveContract.Enabled = True
...
Me.txtLeaseDuration.Text = 1
Me.UpDownLeasePeriod.Value = 1
Me.txtContractNo.Text = ""
Me.DTPickerCommencementDate.Value = Date
End Sub
...
On Error GoTo err
With Me
        If .txtLeaseDuration.Text = "" Then Exit Sub
...
On Error GoTo err
        ...
        If Item.Checked = True Then
            ...
            frmODASMSiteRegistration.txtPlotNo.Text = Item.Text
                        ...
                        rsSITE.LoadContract Me.ListView4.ListItems(1).Text
                        showALLINSTALLMENTSDUE
...
Else
        ...
        Item.Selected = False
End If
rsSITE.LoadContract Me.txtContractNo.Text
showALLINSTALLMENTSDUE
End Sub
...
If ListView4.View = lvwList Or Me.ListView4.ListItems.Count <= 1 Then Exit Sub
    If Button = 2 Then
        PopupMenu mnuContractActions
    End If

End Sub

Private Sub mnuDeleteContract_Click()
DeleteContract Me.ListView4.SelectedItem.Text
End Sub
...
Private Sub DeleteContract(ContractNo As String)
On Error GoTo errMSG
        If MsgBox("Are you sure you want to delete this Contract?", vbYesNo) = vbYes Then
            strSQL = "DELETE FROM ODASMLeaseAgreement WHERE ContractNo LIKE '" & ContractNo & "'; "
            strSQL = strSQL + "DELETE FROM ODASMInstallment WHERE ContractNo LIKE '" & ContractNo & "'; "
...
On Error GoTo err
        With frmODASMSiteRegistration
        If .txtCommencementDate.Text = "" Then Exit Sub
