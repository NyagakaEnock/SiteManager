...
Begin VB.Form frmODASRLandLords 
   Caption         =   "LAND LORDS"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ...
   End
End
Attribute VB_Name = "frmODASRLandLords"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New ODASRLandLords
...
Report.RecordSelectionFormula = "{ODASPAccountType.LandLord} = 'Y'"
