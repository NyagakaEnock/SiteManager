...
Begin VB.Form frmODASMSearchRecord 
   BackColor       =   &H00FFFF80&
   ...
   ClientTop       =   435
   ClientWidth     =   6750
   Icon            =   "frmODASMSearchRecord.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5025
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton cmdCancel 
            ...
            Height          =   975
            Left            =   1320
            Picture         =   "frmODASMSearchRecord.frx":0ECA
            Style           =   1  'Graphical
            TabIndex        =   4
            Top             =   200
            Width           =   1095
         ...
         Begin VB.CommandButton cmdOk 
            ...
            Height          =   975
            Left            =   120
            Picture         =   "frmODASMSearchRecord.frx":130C
            Style           =   1  'Graphical
            TabIndex        =   3
            Top             =   200
            Width           =   1215
   ...
   End
End
Attribute VB_Name = "frmODASMSearchRecord"
