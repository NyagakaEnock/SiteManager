...
Begin VB.Form frmALISMReceiptNew 
   Appearance      =   0  'Flat
   ...
   ClientTop       =   1560
   ClientWidth     =   11880
   Icon            =   "frmALISMReceiptNew.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   7155
   ScaleWidth      =   11880
   Begin TabDlg.SSTab SSTReceipt 
      ...
      TabPicture(0)   =   "frmALISMReceiptNew.frx":0442
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "Frame14"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "LOAN DATASHEET"
      TabPicture(1)   =   "frmALISMReceiptNew.frx":045E
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Frame1"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "PROPOSAL DATASHEET"
      TabPicture(2)   =   "frmALISMReceiptNew.frx":047A
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "Frame4"
      Tab(2).ControlCount=   1
      TabCaption(3)   =   "POLICY DATASHEET"
      TabPicture(3)   =   "frmALISMReceiptNew.frx":0496
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "Frame5"
      Tab(3).ControlCount=   1
      TabCaption(4)   =   "RECEIPTS DATASHEET"
      TabPicture(4)   =   "frmALISMReceiptNew.frx":04B2
   ...
   End
End
Attribute VB_Name = "frmALISMReceiptNew"
...
Private Sub cboEmployer_LostFocus()
        If Screen.ActiveForm.cboEmployer.Text = Empty Then Exit Sub
        If bloadINVOICE = True Then
