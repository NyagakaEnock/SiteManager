...
Begin VB.Form frmSysmanMain 
   ...
   EndProperty
   Icon            =   "frmSysmanMain.frx":0000
   LinkTopic       =   "Form1"
   Moveable        =   0   'False
   Picture         =   "frmSysmanMain.frx":0442
   ScaleHeight     =   7185
   ScaleWidth      =   11880
   ...
   Begin ComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "frmSysmanMain.frx":5B80
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmSysmanMain"
...
Private MySysMan As clsSysManager
...
'On Error GoTo Err
    ...
    Set MySysMan = New clsSysManager
