...
Begin VB.Form frmODASRPlotSites 
   Caption         =   "PLOT SITES"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ...
   End
End
Attribute VB_Name = "frmODASRPlotSites"
...
Report.RecordSelectionFormula = "{ODASPPlot.PlotNo} = '" & frmODASMSiteRegistration.txtPlotNo.Text & "';"
