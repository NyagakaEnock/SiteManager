...
Begin VB.Form frmODASSearchSitesTerminated 
   Caption         =   "Searching For Sites/Billboards Terminated - Specified Duration"
   ClientHeight    =   4650
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8565
   ...
   End
End
Attribute VB_Name = "frmODASSearchSitesTerminated"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub SaveReportNo()
With frmODASSearchSitesTerminated
...
On Error GoTo err
        ...
        If bSaveRECORD = True Then
                Load frmRptSitesCancelled
                frmRptSitesCancelled.Show vbModal
        End If
Exit Sub
err:
    ErrorMessage
...
With Me
  ...
  If bSaveRECORD = True Then
     'getLEASESTerminated
     If SchedulingMain.txtTask.Text = "K14" Then
       getLEASESTerminatedLandLord
     Else
       getLEASESTerminatedCompany
     End If
  End If
End With
End Sub
...
Private Sub DTPickerStartDate_CloseUp()
    ...
    Me.txtStartDate.Text = Format(Me.txtStartDate.Text, "dd/mm/yyyy")
End Sub
