...
On Error GoTo err
        With frmODASMSiteRegistration
                ...
                Else
                     strSQL = "SELECT * FROM ODASPAccount Where Status = 'A' AND AccountType = 'LLORD' oRDER BY AccountNo;"
                'strSQL = "SELECT * FROM ODASPAccount,ODASpplot where ODASPAccount.Status='A' AND ODASPAccount.AccountType = 'LLORD' oRDER BY ODASPAccount.AccountNo"
                End If
                rsLIST.Open strSQL, cnCOMMON, adOpenKeyset, adLockOptimistic
...
End Sub
Public Sub getContractToTerminated()
On Error GoTo err
...
On Error GoTo err
        ...
        With frmODASSitesToExpire
                ...
                ElseIf frmODASSitesToExpire.strReport = "ExpiredNotRenewed" Then
...
Public Sub showALLRentPendingPayment()
       'strSQL = "SELECT * FROM ODASMInstallment,ODASPPlot,ODASPAccount,ODASMLeaseAgreement Where (ODASMInstallment.PaymentDueDate >= '" & Format(Screen.ActiveForm.txtStartDate.Value, "yyyy/mm/dd") & "' AND ODASMInstallment.PaymentDueDate <= '" & Format(Screen.ActiveForm.txtLastDate.Value, "yyyy/mm/dd") & "') and ODASMInstallment.PaymentFlag = 'N'  and (ODASMLeaseAgreement.Terminated='N' OR ODASMLeaseAgreement.Terminated IS NULL) and ODASMInstallment.Balance > 0 and ODASPPlot.PlotNo=ODASMInstallment.PlotNo and ODASMInstallment.AccountNo=ODASPAccount.AccountNo ORDER BY CompanyName;"
...
Public Sub showALLRentVouchersPrepared()
       'strSQL = "SELECT * FROM ODASMInstallment,ODASPPlot,ODASPAccount,ODASMLeaseAgreement Where ODASMInstallment.DateRequisitioned <= '" & Format(Screen.ActiveForm.txtLastDate.Value, "yyyy/mm/dd") & "' and (ODASMLeaseAgreement.Terminated='N' OR ODASMLeaseAgreement.Terminated IS NULL) AND ODASPPlot.PlotNo=ODASMInstallment.PlotNo and ODASMInstallment.AccountNo=ODASPAccount.AccountNo AND (ODASMInstallment.Requisitioned ='Y')  ORDER BY CompanyName;"
...
Public Sub showALLRentPendingConfirmation()
        'strSQL = "SELECT * FROM ODASMInstallment,ODASPPlot,ODASPAccount,ODASMLeaseAgreement Where (ODASMInstallment.DateRequisitioned >= '" & Format(Screen.ActiveForm.txtStartDate.Value, "yyyy/mm/dd") & "' AND ODASMInstallment.DateRequisitioned <= '" & Format(Screen.ActiveForm.txtLastDate.Value, "yyyy/mm/dd") & "')AND (ODASMLeaseAgreement.Terminated='N' OR ODASMLeaseAgreement.Terminated IS NULL) and ODASPPlot.PlotNo=ODASMInstallment.PlotNo and ODASMInstallment.AccountNo=ODASPAccount.AccountNo AND (ODASMInstallment.Requisitioned ='Y') AND (ODASMInstallment.PaymentFlag='N' OR ODASMInstallment.PaymentFlag IS NULL)   ORDER BY CompanyName;"
...
Public Sub showALLRentWithPaymentsConfirmed()
      strSQL = "SELECT * FROM ODASMInstallment,ODASPPlot,ODASPAccount Where (ODASMInstallment.DateRequisitioned >= '" & Format(Screen.ActiveForm.txtStartDate.Value, "yyyy/mm/dd") & "' AND ODASMInstallment.DateRequisitioned <= '" & Format(Screen.ActiveForm.txtLastDate.Value, "yyyy/mm/dd") & "') and ODASPPlot.PlotNo=ODASMInstallment.PlotNo and ODASMInstallment.AccountNo=ODASPAccount.AccountNo AND (ODASMInstallment.PaymentFlag ='Y')  ORDER BY CompanyName;"
       Debug.Print strSQL
        FillList strSQL, frmODASSearchSitesNotPaid.ListView1
...
On Error GoTo err
        ...
        With frmODASSearchSitesNotPaid
                ...
                Dim rsLIST As ADODB.Recordset
                Set rsLIST = New ADODB.Recordset
                strSQL = "Select * from ODASMInstallment, ODASPAccount,ODASPPlot Where ODASPPlot.PlotNo=ODASMInstallment.PlotNo AND (ODASMInstallment.Requisitioned = 'N' or ODASMInstallment.Requisitioned is null or ODASMInstallment.Requisitioned = 'Y' ) and ODASPAccount.AccountNo = ODASPPlot.AccountNo  AND (ODASMInstallment.PaymentDueDate>='" & Format(Screen.ActiveForm.txtStartDate.Value, "yyyy/MM/dd") & "' AND ODASMInstallment.PaymentDueDate<='" & Format(Screen.ActiveForm.txtLastDate.Value, "yyyy/MM/dd") & "') AND ODASMInstallment.Balance>0 AND ODASMInstallment.ContractNo IN (Select ContractNo From ODASMLeaseAgreement where (Terminated='N' OR Terminated IS NULL));"
                'strSQL = "SELECT * FROM ODASMInstallment,ODASPPlot,ODASPAccount Where (ODASMInstallment.PaymentDueDate >= '" & Format(Screen.ActiveForm.txtStartDate.Value, "yyyy/mm/dd") & "' AND ODASMInstallment.PaymentDueDate <= '" & Format(Screen.ActiveForm.txtLastDate.Value, "yyyy/mm/dd") & "') and ODASMInstallment.PaymentFlag = 'N' and ODASMInstallment.Balance > 0 and ODASPPlot.PlotNo=ODASMInstallment.PlotNo and ODASMInstallment.AccountNo=ODASPAccount.AccountNo AND ODASMInstallment.ContractNo IN (Select ContractNo From ODASMLeaseAgreement where (Terminated='N' OR Terminated IS NULL));"
                'strSQL = "SELECT * FROM ODASMInstallment,ODASPPlot,ODASPAccount,ODASMLeaseAgreement Where (ODASMInstallment.PaymentDueDate >= '" & Format(Screen.ActiveForm.txtStartDate.Value, "yyyy/mm/dd") & "' AND ODASMInstallment.PaymentDueDate <= '" & Format(Screen.ActiveForm.txtLastDate.Value, "yyyy/mm/dd") & "') and ODASMInstallment.PaymentFlag = 'N' and ODASMInstallment.Balance > 0 and ODASPPlot.PlotNo=ODASMInstallment.PlotNo   AND (ODASMLeaseAgreement.Terminated='N' OR ODASMLeaseAgreement.Terminated IS NULL) and ODASMInstallment.AccountNo=ODASPAccount.AccountNo and ODASMInstallment.AccountNo=ODASMLeaseAgreement.AccountNo;"
Debug.Print strSQL
                rsLIST.Open strSQL, cnCOMMON, adOpenKeyset, adLockOptimistic
