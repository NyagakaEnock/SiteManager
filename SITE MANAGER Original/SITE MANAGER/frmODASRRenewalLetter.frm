...
Begin VB.Form frmODASRContractRenewalLetter 
   ...
   End
End
Attribute VB_Name = "frmODASRContractRenewalLetter"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New ODASRenewalLetter

Private Sub Form_Load()
Screen.MousePointer = vbHourglass: Dim myCrystalLogon As New clsCrystallogon
Report.RecordSelectionFormula = "{ODASMLeaseAgreement.ContractNo } = '" & frmODASMSendNotice.txtContractNo.Text & "'"
