...
Begin VB.Form frmODASPMediaTask 
   Caption         =   "Media Setup"
   ClientHeight    =   4740
   ClientLeft      =   60
   ClientTop       =   1170
   ClientWidth     =   9225
   Icon            =   "frmODASPMediaTask.frx":0000
   LinkTopic       =   "Form1"
   Picture         =   "frmODASPMediaTask.frx":0442
   ScaleHeight     =   4740
   ScaleWidth      =   9225
   Begin VB.Frame Frame12 
      ...
      Begin VB.Frame Frame2 
         Caption         =   "Actual Tasks Set for the Media"
         Height          =   3015
         Left            =   3960
         TabIndex        =   17
         Top             =   1440
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.CommandButton cmdAddNew 
            ...
            Height          =   375
            Left            =   120
            Picture         =   "frmODASPMediaTask.frx":0784
            Style           =   1  'Graphical
            TabIndex        =   0
            Top             =   240
            Width           =   855
         ...
         Begin VB.CommandButton cmdUpdate 
            ...
            Height          =   375
            Left            =   120
            Picture         =   "frmODASPMediaTask.frx":0886
            Style           =   1  'Graphical
            TabIndex        =   7
            Top             =   600
            Width           =   855
         ...
         Begin VB.CommandButton cmdSearch 
            ...
            Height          =   375
            Left            =   120
            Picture         =   "frmODASPMediaTask.frx":0988
            Style           =   1  'Graphical
            TabIndex        =   9
            Top             =   1365
            Width           =   855
         ...
         Begin VB.CommandButton cmdDelete 
            ...
            Height          =   375
            Left            =   120
            Picture         =   "frmODASPMediaTask.frx":0A8A
            Style           =   1  'Graphical
            TabIndex        =   8
            Top             =   1740
            Width           =   855
         ...
         Begin VB.CommandButton cmdCancel 
            ...
            Height          =   375
            Left            =   120
            Picture         =   "frmODASPMediaTask.frx":0B8C
            Style           =   1  'Graphical
            TabIndex        =   6
            Top             =   2115
            Width           =   855
         ...
         Begin VB.CommandButton cmdPrint 
            ...
            Height          =   375
            Left            =   120
            Picture         =   "frmODASPMediaTask.frx":0C8E
            Style           =   1  'Graphical
            TabIndex        =   5
            Top             =   2520
            Width           =   855
   ...
   End
End
Attribute VB_Name = "frmODASPMediaTask"
...
'On Error GoTo err
    ...
    strSQL = "Select * from ODASPMediaTask Where MediaCode = '" & frmODASPMediaTask.txtMediaCode.Text & "'"
    ...
    With rsCONTROL
        ...
        frmODASPMediaTask.txtMediaCode = !MediaCode
        frmODASPMediaTask.txtMediaDescription = !categoryname
                            
        If !Status = "A" Then
                frmODASPMediaTask.chkActive.Value = 1
        Else: frmODASPMediaTask.chkActive.Value = 0
        End If
    End With
...
Else
        If MsgBox("Are you sure you want to completely delete the current record?", vbQuestion + vbYesNo, "Confirm Delete") = vbYes Then
            ...
            strSQL = "Select * from ODASPMediaCode Where MediaCode = '" & frmODASPMediaTask.txtMediaCode.Text & "'"
            rsCONTROL.Open strSQL, cnCOMMON, adOpenKeyset, adLockOptimistic
...
'On Error GoTo err
        ...
        If Screen.ActiveForm.txtMediaCode.Text = "" Then
                MsgBox "The Operation Type MUST be Entered"
                Screen.ActiveForm.txtMediaCode.SetFocus
        ElseIf Screen.ActiveForm.txtMediaDescription.Text <= "" Then
...
''On Error GoTo err
    ...
    strSQL = "Select * from ODASPMediaTask Where MediaCode = '" & frmODASPMediaTask.txtMediaCode.Text & "' and departmentCode = '" & frmODASPMediaTask.txtDeptCode.Text & "'"
    rsCONTROL.Open strSQL, cnCOMMON, adOpenKeyset, adLockOptimistic
    
   With rsCONTROL
        If .BOF Or .EOF Then
                .AddNew
                !MediaCode = frmODASPMediaTask.txtMediaCode
                !PreparedBy = CurrentUserName
                !DatePrepared = Date
        End If
        
        !DepartmentCode = frmODASPMediaTask.txtDeptCode.Text
        
        If frmODASPMediaTask.chkActive = 1 Then
                !Status = "A"
            Else: !Status = "I"
        End If
...
'On Error GoTo err
        ...
        If Item.Checked = True And baddRECORD = True Or beditRECORD = True Or bsearchRECORD = True Then
            ...
            frmODASPMediaTask.txtDeptCode.Text = Item.Text
            frmODASPMediaTask.txtDepartmentDescription.Text = Item.SubItems(1)
            showALLTASKS
            'loadRECORD
        Else
            Item.Checked = False
