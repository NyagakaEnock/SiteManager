...
Begin VB.Form frmODASRRentPaymentInstallments 
   Caption         =   "RENT PAYMENT INSTALLMENTS"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   End
End
Attribute VB_Name = "frmODASRRentPaymentInstallments"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New ODASRentPaymentInstallments

Private Sub Form_Load()
Screen.MousePointer = vbHourglass: Dim myCrystalLogon As New clsCrystallogon
'Report.RecordSelectionFormula = "{ODASMLeaseAgreement.ContractNo} = '" & CurrentRecord & "' and {ODASMLeaseAgreement.ContractNo} = {ODASMInstallment.ContractNo} and {ODASMInstallment.ContractYear}= " & CLng(INPQRY2) & ""
