...
Begin VB.Form frmODASSearchSiteNewSites 
   Caption         =   "Searching For New Sites/Billboards  - Specified Duration"
   ClientHeight    =   4410
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8565
   ...
   End
End
Attribute VB_Name = "frmODASSearchSiteNewSites"
...
Private Sub DTPickerLastDate_CloseUp()
   ...
   Me.txtLastDate.Text = Format(Me.txtLastDate.Text, "dd/mm/yyyy")
End Sub
