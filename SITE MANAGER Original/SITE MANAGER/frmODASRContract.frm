...
Begin VB.Form frmODASRContract 
   ...
   End
End
Attribute VB_Name = "frmODASRContract"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New ODARContractRenewal

Private Sub Form_Load()
Screen.MousePointer = vbHourglass: Dim myCrystalLogon As New clsCrystallogon
Report.RecordSelectionFormula = "{ODASMLeaseAgreement.ContractNo } = '" & frmODASMLeaseRenewal.txtContractNo.Text & "'"
